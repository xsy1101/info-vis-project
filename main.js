...
(() => {
    ...
    const advWidth = 1100;
    const advHeight = 620;
    const advMargin = { top: 70, right: 35, bottom: 70, left: 70 };
    ...
    function renderViz1() {
        ...
        chart.selectAll(".viz1-col")
            ...
            .attr("height", 0)
            .attr("fill", "rgba(180, 92, 118, 0.22)")
            .attr("stroke", "rgba(227, 147, 169, 0.45)")
            .transition()
            .duration(700)
            .attr("y", d => y(d.total))
        ...
        chart.selectAll(".viz1-person")
            ...
            .attr("x", d => x(d.year) + (x.bandwidth() - iconsPerRow * iconSize) / 2 + d.col * iconSize)
